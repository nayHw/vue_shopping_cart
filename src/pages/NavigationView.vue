                    ...
                    <li class="nav-item dropdown mr-3">
                        ...
                        <div class="dropdown-menu mt-2 md-mt-0" aria-labelledby="navbarDropdown" @click="$event.stopPropagation()">
                            <div v-if="cartProduct">
                                <div v-for="cart in cartProduct" :key="cart.product.id" class="border-bottom border-info mx-2">
                            ...
                            <div v-if="cartProduct.length <= 0" class="border-bottom border-info mx-2">
